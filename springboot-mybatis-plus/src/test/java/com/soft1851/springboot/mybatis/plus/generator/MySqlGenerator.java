package com.soft1851.springboot.mybatis.plus.generator;
...
public class MySqlGenerator {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://localhost:3306/bbs?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai")
                .setUsername("root")
                .setPassword("root");
